...
public class HoodCommand extends CommandBase {
    ...
    private jStickListener jStick;
    private JoystickButton aButton;

    public HoodCommand(HoodSubsystem m_hoodSubsystem, LimelightSubsystem m_limelightSubsystem, jStickListener jStick,
    ...
    public void execute() {
        if (autoTarget) {
            ...
            // m_hoodSubsystem.turn(jStick.getY());
        }
    }
